  ...
  return (
    <Link to="/Djikstra">
      <div className="ease-(--my-beizer) duration-300 hover:scale-[110%] flex flex-col items-center justify-center m-5 w-150 p-6 bg-neutral-800 border-2 border-neutral-800 rounded-lg">
        <img src="src/assets/Djikstra.webp" className="object-cover w-auto" alt="A Photo of Edgsar Djikstra" />
...
function StrassenButton() {
  return (
    <Link to="/Matrix">
    <div className={`ease-(--my-beizer) duration-300 hover:scale-[110%] flex flex-col items-center justify-center m-5 w-150 p-6 bg-neutral-800 border-2 border-neutral-800 rounded-lg`}>
      <img src="src/assets/Strassen.webp" className="object-cover w-auto" alt="A Photo of Edgsar Djikstra" />
